...
Real-world ways people use gapes to turn agent output into shareable, gated pages.

## Security review reports, shared with a friend

I use the gapes skill inside my agent as the last mile of a source-code
...
plain Markdown), then deploy them together to my gapes server as a single
...
prompt output. Today I use the Hermes agent, and with the gapes skill it can
transform that Markdown into HTML and serve it on my internal gapes. It is far
